...
This skill supports **Python only**. All examples read from `python/`.

1. **Look at project files** to confirm Python:

   - `*.py`, `requirements.txt`, `pyproject.toml`, `setup.py`, `Pipfile` → **Python** — read from `python/`

2. **If a non-Python language is detected**, note that only Python is supported by this skill and suggest using the official Anthropic SDK documentation for other languages.
...
Read the **Python Agent SDK folder** (`python/agent-sdk/`).
